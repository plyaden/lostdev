            ...
            <button
                ...
                onClick={() => {
                   ...
                   startJoyride([
                    ...
                    { target: 'body > div:nth-child(7) > div > div.modal.fade.show > div > div > div.modal-body > div > div:nth-child(1) > div > div > div', content: 'U need to click on the Datasource u want to selct, for our example its only Admin, so admin is selcted.'},
